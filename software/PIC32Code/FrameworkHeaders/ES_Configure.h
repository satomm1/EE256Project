...
#define SERV_0_HEADER "UsbOutService.h"
// the name of the Init function
#define SERV_0_INIT InitUsbOutService
// the name of the run function
#define SERV_0_RUN RunUsbOutService
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "TemperatureSM.h"
// the name of the Init function
#define SERV_1_INIT InitTemperatureSM
// the name of the run function
#define SERV_1_RUN RunTemperatureSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "WiFiSM.h"
// the name of the Init function
#define SERV_2_INIT InitWiFiSM
// the name of the run function
#define SERV_2_RUN RunWiFiSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "PumpSM.h"
// the name of the Init function
#define SERV_3_INIT InitPumpSM
// the name of the run function
#define SERV_3_RUN RunPumpSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "DisplaySM.h"
// the name of the Init function
#define SERV_4_INIT InitDisplaySM
// the name of the run function
#define SERV_4_RUN RunDisplaySM
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "UserButtonSM.h"
// the name of the Init function
#define SERV_5_INIT InitUserButtonSM
// the name of the run function
#define SERV_5_RUN RunUserButtonSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public function prototypes
#define SERV_6_HEADER "WaterButtonSM.h"
// the name of the Init function
#define SERV_6_INIT InitWaterButtonSM
// the name of the run function
#define SERV_6_RUN RunWaterButtonSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 7
// the header file with the public function prototypes
#define SERV_7_HEADER "SoilMoistureSM.h"
// the name of the Init function
#define SERV_7_INIT InitSoilMoistureSM
// the name of the run function
#define SERV_7_RUN RunSoilMoistureSM
// How big should this services Queue be?
...
typedef enum
{
  ...
  EV_USER_BUTTON_UP,
  EV_USER_BUTTON_DOWN,
  EV_USER_BUTTON_PRESSED,
  EV_USER_BUTTON_RELEASED,
  EV_WATER_BUTTON_UP,
  EV_WATER_BUTTON_DOWN,
  EV_UPDATE_TEMP,
  EV_SPI1_TX_FINISHED,
  EV_SPI1_RX_RECEIVED,
  EV_SPI2_TX_FINISHED,
  EV_ADD_WATER,
  EV_WATER_PRESS,
  EV_BEGIN_UNIT_SELECT,
  EV_END_UNIT_SELECT, 
  EV_SEND_WIFI_THRESHOLD_UPDATE,
  EV_SEND_WIFI_UNIT_UPDATE,
  EV_SEND_WIFI_MOISTURE_UPDATE,
...
#define EVENT_CHECK_LIST Check4Keystroke, CheckUserButton, CheckWaterButton
...
#define TIMER8_RESP_FUNC PostDisplaySM
#define TIMER9_RESP_FUNC PostSoilMoistureSM
#define TIMER10_RESP_FUNC PostPumpSM
#define TIMER11_RESP_FUNC PostSoilMoistureSM
#define TIMER12_RESP_FUNC PostTemperatureSM
#define TIMER13_RESP_FUNC PostWaterButtonSM
#define TIMER14_RESP_FUNC PostUserButtonSM
#define TIMER15_RESP_FUNC PostUsbOutService
...
#define DISPLAY_TIMER 8
#define SOIL_MOISTURE_AFTER_WATER_TIMER 9
#define PUMP_TIMER 10
#define SOIL_MOISTURE_TIMER 11
#define TEMPERATURE_UPDATE_TIMER 12
#define WATER_DEBOUNCE_TIMER 13
#define USER_DEBOUNCE_TIMER  14
#define USB_UPDATE_TIMER     15
